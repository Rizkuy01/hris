...
class M_User extends Model
{
    ...
    protected $allowedFields = ['username', 'email', 'role', 'divisi', 'position', 'password_hash'];
    ...
    public function list()
    {
        ...
        $this->builder->select('users.id as userid, username, email, name, user_image, divisi, position, password_hash');
